...
public class DBConstants {
    ...
    public static final String IS_USUAL_VEHICLE = "select count(t.ID) from ticket t where t.VEHICLE_REG_NUMBER=? and DATE(t.OUT_TIME) >= DATE(SUBDATE(NOW(), ?)) and t.price > ?";
}
